...
INSERT INTO room_type (name, description, capacity, bed_type, num_of_beds) VALUES
('Single Room', 'Cozy room for solo travelers', '1', 'Single', '1'),
('Double Room', 'Comfortable room for two guests', '2', 'Double', '1'),
('Suite', 'Luxurious suite with additional amenities', '4', 'King', '2'),
('Family Room', 'Spacious room for families', '4', 'Queen', '2'),
('Penthouse', 'Exclusive penthouse with panoramic views', '2', 'King', '1');

-- Inserting data into the rooms table
INSERT INTO rooms (room_number, level, additional_services, is_occupied, room_type_id, hotel_id) VALUES
(101, '1st Floor', 'Mini Bar, WiFi', 0, 1, 1),
(201, '2nd Floor', 'Ocean View, Jacuzzi', 0, 3, 2),
(301, '3rd Floor', 'Mountain View, Fireplace', 0, 5, 3),
(102, '1st Floor', 'City View, Gym Access', 0, 2, 4),
(202, '2nd Floor', 'Lake View, Room Service', 0, 4, 5);

-- Inserting data into the payment table
INSERT INTO payment (amount, payment_method, currency, payment_date, billing_address, booking_id) VALUES
(150, 'Credit Card', 'USD', '2024-05-16', '123 Billing Street', 1),
(300, 'PayPal', 'USD', '2024-06-21', '456 Billing Road', 2),
(200, 'Debit Card', 'USD', '2024-07-11', '789 Billing Lane', 3),
(180, 'Cash', 'USD', '2024-08-06', '101 Billing Avenue', 4),
(250, 'Bank Transfer', 'USD', '2024-09-16', '222 Billing Boulevard', 5);
create table user (user_id int not null primary key AUTO_INCREMENT, name varchar(50), email varchar(50), password varchar(60), mobile_number varchar(10), age int);
